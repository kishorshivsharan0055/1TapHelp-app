...
public class BackgroundFrontImage extends Service implements SurfaceHolder.Callback {
    // Camera variables
    // a surface holder
...
//                WindowManager.LayoutParams.TYPE_PHONE,
    ...
    Camera.PictureCallback mCall = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            if (!imagesFolder.exists())
                imagesFolder.mkdirs();
            File image = new File(imagesFolder +  "/1.jpg");
    ...
    public void getFileToByte(){
        ...
        editor.putString("front_image", encodeString);
        Log.e("front ", encodeString);
        editor.commit();
    }
}
