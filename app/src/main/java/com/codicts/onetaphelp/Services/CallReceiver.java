...
//        context.startService(service);
        ...
        if (Objects.equals(intent.getAction(), Intent.ACTION_NEW_OUTGOING_CALL)) {
            String phNo = getResultData();
            if (phNo.equals("0101")) {
                setResultData(null);
                Log.d("1TapHelp.CallReceiver.", "onReceive: Dialed Number : " + phNo);
    ...
    public void getLocation(Context context) {
        ...
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (GPSLocation != null) {
                ...
                Toast.makeText(context, "Null Location Returned", Toast.LENGTH_SHORT).show();
            }
        } else {
...
//                Log.d("1TapHelp.CallReceiver", "onLocationResult: " + lat + ", log" + log);
//                sendSignal(context);
